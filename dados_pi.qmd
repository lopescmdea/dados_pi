...
Do Carregamento dos pacotes utilizados: `sidrar` para acesso à API do SIDRA/IBGE, `tidyverse` para manipulação de dados, `geobr` e `sf` para dados geoespaciais, e `patchwork` para composição de gráficos.
...
participacao |>
  ...
  knitr::kable(
    caption = "Participação setorial no Valor Adicionado dos municípios do Piauí — 2021"
  )
